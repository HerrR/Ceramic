...
(function() {
    ...
    angular
        .module('cvc')
        .controller('CvcSidebarController', Controller);

    Controller.$inject = ['$scope', '$state', '$http', '$filter', '$timeout', 'ProfileService', 'AppConstants', 'ScreenMessageService', 'DatasetService', 'Upload', 'UtilityService'];

    function Controller($scope, $state, $http, $filter, $timeout, ProfileService, AppConstants, ScreenMessageService, DatasetService, Upload, UtilityService) {
        $scope.profile = ProfileService.getProfile();

        $scope.hideSidebar = function(){
            return $state.current.name !== "person.cv";
        };
    }
})();
